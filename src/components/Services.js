...
export default function Services(){
    ...
    return (
      <section className='min-h-[75vh] my-10 pt-16 js-show-on-scroll' id='services'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 my-2 bg-darker-800 p-2 rounded-md'>

          <div className='flex flex-col p-2 border-darker-300 border-2 rounded-md m-1'>
          ...
          <div id='last-svc' className='flex flex-col p-2 border-darker-300 border-2 rounded-md m-1'>
